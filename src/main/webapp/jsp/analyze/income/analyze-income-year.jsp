...
<html>
<head>
    <title>Анализ доходов за год</title>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="period-navigation">
                ...
                <a href="${pageContext.request.contextPath}/analyze-income/year" class="period-btn active">За год</a>
            </div>
        </div>
        ...
        <div class="chart-stats-container">
            <div class="chart-section">
                <div class="chart-title">Распределение доходов за год</div>
                <div class="chart-container">
                    <img src="${pageContext.request.contextPath}/chart/income?period=year"
                         alt="График доходов по категориям за год"
            ...
            <div class="stats-cards-vertical">
                <div class="stat-card income">
                    <div class="stat-label">Доходы за год</div>
        ...
        <div class="data-section">
            <div class="section-card">
                <div class="section-title">Топ категорий доходов за год</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет доходов за год</div>
                    </c:otherwise>
                </c:choose>
            </div>
