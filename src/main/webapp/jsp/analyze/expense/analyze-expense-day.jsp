...
<html>
<head>
    <title>Анализ расходов за день</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/head.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/analyze-expense.css">
</head>
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="period-navigation">
                <a href="${pageContext.request.contextPath}/analyze-expense/day" class="period-btn active">За день</a>
                <a href="${pageContext.request.contextPath}/analyze-expense/week" class="period-btn">За неделю</a>
                <a href="${pageContext.request.contextPath}/analyze-expense/month" class="period-btn">За месяц</a>
                <a href="${pageContext.request.contextPath}/analyze-expense/year" class="period-btn">За год</a>
            </div>
        </div>
        ...
        <div class="chart-stats-container">
            <div class="chart-section">
                <div class="chart-title">Распределение расходов за день</div>
                <div class="chart-container">
                    <img src="${pageContext.request.contextPath}/chart/expense?period=day"
                         alt="График расходов по категориям за день"
            ...
            <div class="stats-cards-vertical">
                <div class="stat-card expense">
                    <div class="stat-label">Расходы за день</div>
        ...
        <div class="data-section">
            <div class="section-card">
                <div class="section-title">Топ категорий расходов за день</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет расходов за сегодня</div>
                    </c:otherwise>
                </c:choose>
            </div>
