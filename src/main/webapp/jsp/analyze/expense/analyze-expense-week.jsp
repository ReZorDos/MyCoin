...
<html>
<head>
    <title>Анализ расходов за неделю</title>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="period-navigation">
                <a href="${pageContext.request.contextPath}/analyze-expense/day" class="period-btn">За день</a>
                <a href="${pageContext.request.contextPath}/analyze-expense/week" class="period-btn active">За неделю</a>
        ...
        <div class="chart-stats-container">
            <div class="chart-section">
                <div class="chart-title">Распределение расходов за неделю</div>
                <div class="chart-container">
                    <img src="${pageContext.request.contextPath}/chart/expense?period=week"
                         alt="График расходов по категориям за неделю"
            ...
            <div class="stats-cards-vertical">
                <div class="stat-card expense">
                    <div class="stat-label">Расходы за неделю</div>
        ...
        <div class="data-section">
            <div class="section-card">
                <div class="section-title">Топ категорий расходов за неделю</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет расходов за неделю</div>
                    </c:otherwise>
                </c:choose>
            </div>
            ...
            <div class="section-card">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет транзакций за неделю</div>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
