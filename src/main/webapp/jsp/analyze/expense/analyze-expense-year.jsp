    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="period-navigation">
                ...
                <a href="${pageContext.request.contextPath}/analyze-expense/year" class="period-btn active">За год</a>
            </div>
        </div>
        ...
        <div class="chart-stats-container">
            <div class="chart-section">
                <div class="chart-title">Распределение расходов за год</div>
            ...
            <div class="stats-cards-vertical">
                ...
                <div class="stat-card change">
                    ...
                    <div class="stat-label yesterday">
                        Прошлый год: <fmt:formatNumber value="${previousTotal}" pattern="#,##0.00"/> ₽
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="data-section">
            <div class="section-card">
                <div class="section-title">Топ категорий расходов за год</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет расходов за год</div>
                    </c:otherwise>
                </c:choose>
            </div>

            <div class="section-card">
                <div class="section-title">Топ транзакций за год</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет транзакций за год</div>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
