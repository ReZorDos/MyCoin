    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <div class="period-navigation">
                ...
                <a href="${pageContext.request.contextPath}/analyze-expense/month" class="period-btn active">За месяц</a>
        ...
        <div class="chart-stats-container">
            <div class="chart-section">
                <div class="chart-title">Распределение расходов за месяц</div>
                <div class="chart-container">
                    <img src="${pageContext.request.contextPath}/chart/expense?period=month"
                         alt="График расходов по категориям за месяц"
        ...
        <div class="data-section">
            <div class="section-card">
                <div class="section-title">Топ категорий расходов за месяц</div>
                <c:choose>
                    ...
                    <c:otherwise>
                        <div class="no-data">Нет расходов за месяц</div>
                    </c:otherwise>
                </c:choose>
            </div>
